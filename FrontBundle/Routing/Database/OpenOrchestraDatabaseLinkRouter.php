...
/**
 * Class OpenOrchestraDatabaseLinkRouter
 */
class OpenOrchestraDatabaseLinkRouter implements RouterInterface
{
    /**
     * @var RequestContext
     */
    ...
    )
    {
        ...
        $this->options = array_merge(array(
            'generator_class' => 'OpenOrchestra\FrontBundle\Routing\Database\OpenOrchestraDatabaseLinkGenerator',
