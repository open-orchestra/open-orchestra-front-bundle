...
use OpenOrchestra\FrontBundle\Routing\Database\OpenOrchestraDatabaseLinkRouter;
use Phake;

/**
 * Test OpenOrchestraDatabaseLinkRouterTest
 */
class OpenOrchestraDatabaseLinkRouterTest extends AbstractBaseTestCase
{
    /**
     * @var OpenOrchestraDatabaseLinkRouter
     */
    protected $router;
    ...
    public function setUp()
    {
        ...
        $this->router = new OpenOrchestraDatabaseLinkRouter(
    ...
    public function testGetGenerator()
    {
        ...
        $this->assertInstanceOf('OpenOrchestra\FrontBundle\Routing\Database\OpenOrchestraDatabaseLinkGenerator', $generator);
    }
